...
namespace VulkanModule {
    VulkanDescriptor::VulkanDescriptor(VulkanDevice* device, VulkanSwapchain* swapchain, VulkanUniformBuffer* uniformbuffer) : vDevice(device), vSwapchain(swapchain), vUniformbuffer(uniformbuffer) {
